...
const modelList = [
    {
        name: 'MidJourney V4',
        id: 'midjourney',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/midjourneyv4.png?v=1.0.0'
    },
    {
        name: 'Realistic Vision',
        id: 'realistic-vision-v13',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/realistic-vision-v13.png?v=1.0.0'
    },
    {
        name: 'GTA5 Artwork',
        id: 'gta5-artwork-diffusi',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/gta5.png?v=1.0.0'
    },
    {
        name: 'Dream Shaper',
        id: 'dream-shaper-8797',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/dream-shaper.png?v=1.0.0'
    },
    {
        name: 'SynthwavePunk',
        id: 'synthwave-diffusion',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/synthwave-punk.png?v=1.0.0'
    },
    {
        name: 'drood_lyriel_v15',
        id: 'droodlyrielv15',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/drood-lyriel.jpeg?v=1.0.0'
    },
    {
        name: 'Redshift Diffusion',
        id: 'redshift-diffusion',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/redshift-diffusion.png?v=1.0.0'
    },
    {
        name: 'Disco Diffusion',
        id: 'disco-diffusion',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/disco-diffusion.jpeg?v=1.0.0'
    },
    {
        name: 'Low Poly World',
        id: 'lowpoly-diffusion',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/lowpoly-diffusion.png?v=1.0.0'
    },
    {
        name: 'Midjv4-PaintArt',
        id: 'midjourney-v4-painta',
        src: 'https://cdn.jsdelivr.net/gh/bfdavid33/tubepro-img-gen/models-pictures/midjourney-v4-painta.png?v=1.0.0'
    },
]
...
function initUI() {
    ...
    heightOptions.style.gap = '0px 20px';
    ...
    sampleLabel.innerHTML = 'Sample Number: ';
    ...
    sampleOptions.style.gap = '0px 20px';
    ...
    upscaleContainer.style.marginBottom = '0px';
